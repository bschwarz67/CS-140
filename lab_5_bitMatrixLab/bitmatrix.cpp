...
/*create Bitmatrix object of with matrix of of dimensions specified by rows, cols*/
...
/*sets matrix at index specified by row, col to val*/
void Bitmatrix::Set(int row, int col, char val)
{
    M[row][col] = val;
}

/*returns val at index specified by row, col*/
...
/*writes the strings that hold the matrix to a file*/
...
/*Interchanges rows in matrix specified by r1, r2*/
